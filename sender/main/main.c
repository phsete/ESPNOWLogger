...
void do_loop()
{
    ...
    initESP_NOW();
        ...
        printf("Hello:sender:%s-NO_SLEEP-EXAMPLE_POWER_SAVE_NONE\n", CONFIG_ESP_LOGGER_VERSION);
    #elif CONFIG_NO_SLEEP && CONFIG_EXAMPLE_POWER_SAVE_MIN_MODEM
        printf("Hello:sender:%s-NO_SLEEP-EXAMPLE_POWER_SAVE_MIN_MODEM\n", CONFIG_ESP_LOGGER_VERSION);
    #elif CONFIG_NO_SLEEP && CONFIG_EXAMPLE_POWER_SAVE_MAX_MODEM
        printf("Hello:sender:%s-NO_SLEEP-EXAMPLE_POWER_SAVE_MAX_MODEM\n", CONFIG_ESP_LOGGER_VERSION);
    #elif CONFIG_DEEP_SLEEP && CONFIG_EXAMPLE_POWER_SAVE_NONE
        printf("Hello:sender:%s-DEEP_SLEEP-EXAMPLE_POWER_SAVE_NONE\n", CONFIG_ESP_LOGGER_VERSION);
    #elif CONFIG_DEEP_SLEEP && CONFIG_EXAMPLE_POWER_SAVE_MIN_MODEM
        printf("Hello:sender:%s-DEEP_SLEEP-EXAMPLE_POWER_SAVE_MIN_MODEM\n", CONFIG_ESP_LOGGER_VERSION);
    #elif CONFIG_DEEP_SLEEP && CONFIG_EXAMPLE_POWER_SAVE_MAX_MODEM
        printf("Hello:sender:%s-DEEP_SLEEP-EXAMPLE_POWER_SAVE_MAX_MODEM\n", CONFIG_ESP_LOGGER_VERSION);
    #endif
